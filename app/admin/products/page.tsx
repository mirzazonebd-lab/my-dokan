                ...
                {filteredProducts.map(product => (
                  <tr key={product.id} className="hover:bg-gray-50">
                    ...
                    <td className="py-3 px-4 text-center">
                      <span className={`inline-flex px-2 py-1 text-xs rounded-full font-medium ${product.stockStatus === 'in_stock' ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-600'
                        }`}>
